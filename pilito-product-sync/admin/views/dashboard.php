...
<div class="wrap pilito-dashboard">
    ...
    <h1 class="pilito-page-title">
        ...
        <?php esc_html_e('داشبورد', 'pilito-product-sync'); ?>
    </h1>
    <p class="pilito-page-description"><?php esc_html_e('وضعیت همگام‌سازی محتوای سایت با هوش مصنوعی', 'pilito-product-sync'); ?></p>
    ...
    <div class="pilito-stats-grid-new">
        ...
        <div class="pilito-stat-card-new">
            <h3 class="stat-title"><?php esc_html_e('صفحات', 'pilito-product-sync'); ?></h3>
            <div class="stat-numbers">
                <span class="stat-main-number"><?php echo number_format_i18n($pages_synced); ?></span>
                <span class="stat-total-number"><?php echo sprintf(__('از %s', 'pilito-product-sync'), number_format_i18n($pages_count)); ?></span>
            </div>
            <p class="stat-description"><?php esc_html_e('همگام‌سازی شده', 'pilito-product-sync'); ?></p>
        </div>
        
        <div class="pilito-stat-card-new">
            <h3 class="stat-title"><?php esc_html_e('نوشته‌ها', 'pilito-product-sync'); ?></h3>
            <div class="stat-numbers">
                <span class="stat-main-number"><?php echo number_format_i18n($posts_synced); ?></span>
                <span class="stat-total-number"><?php echo sprintf(__('از %s', 'pilito-product-sync'), number_format_i18n($posts_count)); ?></span>
            </div>
            <p class="stat-description"><?php esc_html_e('همگام‌سازی شده', 'pilito-product-sync'); ?></p>
        </div>
