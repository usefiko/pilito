...
class Payment(APIView):
    ...
    def post(self, *args, **kwargs):
        ...
        data["description"] = "شارژ حساب اُدینگو"
...
class PaymentVerify(APIView):
    ...
    def get(self, *args, **kwargs):
        ...
        if not authority or status != "OK":
            return redirect('https://audingo.app/panel/callback?success=notok')
        ...
        if response.status_code == 200:
            ...
            if response.get('Status') == 100:
                ...
                return redirect(f'https://audingo.app/panel/callback?success=ok&payment_id={response["RefID"]}')
