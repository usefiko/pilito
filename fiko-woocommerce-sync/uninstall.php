...
// Delete options
delete_option('fiko_wc_api_token');
delete_option('fiko_wc_enable_logging');
delete_option('fiko_wc_api_url');
...
$wpdb->query("DELETE FROM {$wpdb->postmeta} WHERE meta_key LIKE '_fiko_%'");
