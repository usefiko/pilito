...
<div class="wrap fiko-wc-settings">
    ...
    <div id="fiko-test-result" style="display:none; margin-top: 20px;"></div>
    
    <?php if ($token): ?>
    <div class="fiko-wc-card" style="margin-top: 30px;">
        <h2>✅ وضعیت سینک</h2>
    ...
    <div class="fiko-wc-card" style="margin-top: 30px; background: #f0f6fc; border-left: 4px solid #0078d4;">
        <h3>💡 نکات مهم:</h3>
        <ul>
            ...
            <li>در لیست محصولات، ستون "🔄 Fiko" وضعیت سینک هر محصول را نمایش می‌دهد</li>
        </ul>
    </div>
</div>
